        ...
        <div class="w3l-breadcrumb py-lg-5">
            <div class="container pt-4 pb-sm-4">
                ...
                <ul class="breadcrumbs-custom-path">
                    <li><a>Seller</a></li>
                    <li class="active"><i class="fas fa-angle-right">Add Seller</i></li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section class="w3l-contact py-5" id="contact">
        <div class="container py-md-5 py-4">
            <div class="title-main text-center mx-auto mb-md-5 mb-4" style="max-width:500px;">
                ...
                <h3 class="title-style">Add Expert</h3>
            </div>
                ...
                <div class="col-md-7 contact-right">
                    ...
                    <div class="input-grids">
                        ...
                        <div class="text-start">
                            <button class="btn btn-style btn-style-3" type="submit" name="regbtn">SignUp</button>
                        </div>
                    </form>
                    <?php
...
if (isset($_REQUEST['regbtn'])) {
    ...
    if ($rs['cnt'] > 0) {
        ...
        mysqli_query($conn, "INSERT INTO `tb_center_register` (`centername`,`email`,`address`,`contact`,`password`)VALUES('$uname','$uemail','$uaddress','$ucontact','$upass')");
        $QRY2 = "INSERT INTO `tb_login` (`reg_id`,`user_type`,`uphone`,`upass`,`status`)values((SELECT max(`reg_id`) from `tb_center_register`),'CENTER','$ucontact','$upass','ACTIVE')";

        // echo $QRY2;
        mysqli_query($conn, $QRY2);
        echo "<script>alert('Seller Added')</script>";
        echo "<script>window.location.href='addsellers.php';</script>";
    }
}
