...
<head>
    ...
    <title>Online-cafeteria-Admin</title>
    <!-- Google fonts -->
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="newitems.php">New Food Items</a>
                        </li>

                        <li class="nav-item">
                        <a class="nav-link" href="sellermybooking.php">Order Requests</a>
                        </li>
                        ...
                        <!-- <li class="nav-item">
                            <a class="nav-link" href="updatestouser.php">Updates</a>
                        </li> -->
                        <li class="nav-item">
